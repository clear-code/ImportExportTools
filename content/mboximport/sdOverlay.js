...
function SDexportMsg() {
	...
	var type = rg[rg.length-1].selectedIndex;
	if (type == 1 || type == 2) {
...
function SDinit() {
	...
	if (window.arguments[1]) {
		sb.previousSibling.removeAttribute("hidden");
		sb.previousSibling.previousSibling.childNodes[1].setAttribute("hidden", "true");
	}
